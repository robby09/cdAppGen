...
import iquestgroup.com.festivalapp.R;
import test.utils.FileUtils;
import test.utils.PermissionHelper;
import test.utils.UriHelper;
...
public class CsvPickerFragment extends Fragment implements View.OnClickListener {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE_PERMISSION_READ_EXTERNAL_STORAGE || requestCode == REQUEST_CODE_PERMISSION_READ_EXTERNAL_STORAGE_DEMO
    ...
    private void pickCsvFile() {
        ...
        startActivityForResult(Intent.createChooser(intent, "pick file"), REQUEST_CODE_PICK_CSV);
    }
